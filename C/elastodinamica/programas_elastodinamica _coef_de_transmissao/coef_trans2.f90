...
real,dimension(n+1,5)::r_mod !módulo do coeficiente de transmissao
...
real:: alfa_1 !alfa_1 é a velocidade da onda p na camada de cima
real:: alfa_2 !alfa_2 é a velocidade da onda p na camada de baixo
...
real:: r_mod_func !!funcao q retorna o modulo do coeficiente de transmissao
...
r_mod_func = abs( (2.*beta_1 * cos(fi_rad)) / ( beta_1 * cos(fi_rad) + beta_2 * cos(fi2_radianos)) )
