...
implicit none
!=======================================================================================
!objetivo: Obter os modulos dos coeficientes de transmissao para o caso beta_1 > beta_2
!
...
real,dimension(n+1,5)::b_mod !módulo do coeficiente de transmissao
...
real:: b_mod_func !!funcao q retorna o modulo do coeficiente de transmissao
...
beta_1 = 1.0+j*0.1
	...
	do i=0, n 
		!o módulo do coeficiente de transmissao é dado por
		b_mod(i,j) = b_mod_func(beta_1, beta_2, fi_radianos, i, n)
	end do
...
write(11,100) fi(i), (b_mod(i,j), j=1,5)
end do
100 format (1x, f10.4, 5(f10.4))

end program coeficiente_de_reflexao

!aqui inicia a function que calcula o módulo do coeficiente de transmissao
!========================================================================================================================================================================

real function b_mod_func(beta_1, beta_2, fi_radianos, i, n)
implicit none
...
!calcula-se o módulo do coeficiente de transmissao
b_mod_func = abs( (2.*beta_1 * cos(fi_rad) ) / ( beta_1 * cos(fi_rad) + beta_2 * cos(fi2_radianos)) )
