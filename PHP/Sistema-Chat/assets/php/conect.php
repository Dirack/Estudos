...
$password = "roxinaroxmpica19"; // Sua senha no servidor aqui
$db_name = "cadastro"; //banco de dados (database)

// Conexão com o servidor
$connect = mysqli_connect($servername, $username, $password, $db_name) or die("mensagens.php: Falha na conexão com o banco de dados!");
